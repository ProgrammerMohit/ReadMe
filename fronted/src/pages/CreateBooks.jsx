...
const CreateBooks = () => {
  ...
  const handleSaveBook = () => {
    ...
    setLoading(true);
    axios
      .post('https://read-me-7kt4.vercel.app/books', data)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-red-400 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
          <label className='text-xl mr-4 text--500'>Title</label>
          <input
            type='text'
            value={title}
        ...
        <button className='p-2 bg-red-500 m-8' onClick={handleSaveBook}>
          Save
        </button>
      </div>
    </div>
